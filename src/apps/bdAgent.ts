...
const BDAgentComponent: React.FC<{ instanceId: string; isFocused: boolean; }> = () => {
    return React.createElement(PlaceholderComponent, { appName: "BD Agent" });
};

// Added missing category
export const bdAgentApp: AppDef = {
    id: 'bd-agent',
    name: 'BD Agent',
    component: BDAgentComponent,
    icon: '🕵️',
    category: 'Communication',
    defaultSize: { width: 500, height: 400 },
    description: 'A placeholder for a future agent-based application.'
};
